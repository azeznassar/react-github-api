...
class Repo extends React.Component {
    render() {
        return (
            <div className="repo"> 
                <a href={`https://github.com/${this.props.full_name}`} target="_blank" rel="noopener noreferrer" >
                ...
                <div className="repoInfo">
                    ...
                    <a href={`https://github.com/${this.props.full_name}/stargazers`} target="_blank" rel="noopener noreferrer" >
                        <p className="repoItem link"><span className="repoIcon" role="img" aria-label="Star Emoji">⭐</span> {this.props.stargazers}</p>
                    </a>
                    <a href={`https://github.com/${this.props.full_name}/network`} target="_blank" rel="noopener noreferrer" >
